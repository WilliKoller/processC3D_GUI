folder = 'C:\Users\willi\Documents\UniDataLokal\DEMAND\VICON_DATA_SCHMELZ\TD02\2021_05_17\static_01\';
...
for t=1:length(squeeze(markerDataOfInterest(contains(markersOfInterest, 'RASI'), :, :)))
